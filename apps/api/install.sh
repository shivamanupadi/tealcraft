...
yarn build-api
cd apps/api
PORT=9002 pm2 start ecosystem.config.js

docker-compose up -d

echo -e "\033[32m\nCongratulations! Your tealcraft-api instance is ready to use.\n\033[0m"
echo -e "\033[32m\nPlease visit http://$(curl -4s https://ifconfig.io):9002 to get started.\n\033[0m"
